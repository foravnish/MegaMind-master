...
public class MyPrefrences {
    ...
    public static SharedPreferences userImage;
    ...
    public static void setUserImage(Context context, String is) {
        userImage = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = userImage.edit();
        editor.putString("USERIMAGE", is);
        editor.commit();
    }

    public static String getUserImage(Context context) {
        userImage = PreferenceManager.getDefaultSharedPreferences(context);
        return userImage.getString("USERIMAGE","");
    }
    ...
    public static void setDOB(Context context, String is) {
